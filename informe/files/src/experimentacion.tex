...
Respecto a la parte optativa, realizaremos un análisis de las direcciones IP dentro de los paquetes ARP. Ya que este es un protocolo de capa de enlace, y local a cada una de las redes, esto nos permitirá observar las IPs propias de cada red con mayor detalle. Para ello, capturaremos hasta $1000$ tramas por red bajo un contexto de uso normal de los dispositivos, en diferentes horarios del día. 

A partir de las tramas capturadas, generaremos una segunda fuente de información de memoria nula, tal que cada símbolo sea del tipo \textit{$\langle$src ip, dst ip$\rangle$}. De este modo, de existir algún host \textit{distinguido} ---es decir, en términos de la cantidad de información que provee---, lo podremos identificar.
