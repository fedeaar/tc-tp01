...
Respecto a la parte optativa, realizaremos un análisis de las direcciones IP dentro de los paquetes ARP. Ya que este es un protocolo de capa de enlace, y local a cada una de las redes, esto nos permitirá observar las IPs propias de cada red con mayor detalle. 
